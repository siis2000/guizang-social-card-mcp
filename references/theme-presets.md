...
## Neo-Chinese Palettes

The third visual system. Grounded in Chinese art materials. Use with `assets/template-neochinese-card.html`. Switch via `<html data-neo-theme="...">`

| Theme | Base | Ink | Accent | Gold | Best for |
|---|---|---|---|---|---|
| **Vermilion Ink** | `#f5efe0` | `#1a1a1a` | `#c23b22` | `#b8963e` | General default, calligraphy, guofeng |
| **Celadon** | `#e8ede4` | `#1e2b23` | `#5b8c6f` | `#8a9e6b` | Tea ceremony, porcelain, Jiangnan |
| **Ochre** | `#f0e4d0` | `#231711` | `#a0522d` | `#c2984a` | Dunhuang, desert, autumn |
| **Indigo** | `#1b2440` | `#f0ebe0` | `#d4a94e` | `#d4a94e` | Dark themes, night scenes, wuxia |
| **Bamboo** | `#edf2e8` | `#162318` | `#4a7c59` | `#7a9b5a` | Nature, solar terms, landscape |

Neo-Chinese palette rules:
- Use `--neo-paper` as the main background (rice-paper tone).
- Use `--neo-accent` for seal stamps, cinnabar annotations, accent rules.
- `--neo-gold` is optional for gilt borders; never use as body text.
- Each palette has exactly one seal color; do not mix across palettes.
- The Indigo palette is the only dark variant. Do not improvise additional dark themes.
